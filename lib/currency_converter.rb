...
#     base = REXML::XPath.match(doc, '//Cube[@time="2017-03-13"]/Cube[@currency="USD"]/@rate').at(0).value
#     counter = REXML::XPath.match(doc, '//Cube[@time="2017-03-13"]/Cube[@currency="GBP"]/@rate').at(0).value
